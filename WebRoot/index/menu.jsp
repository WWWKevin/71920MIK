...
<dl class="leftmenu">
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="selectservlet">查看信息</a><i></i></li>
		</ul>    
	</dd>
	<dd>
		<div class="title">
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="module_password/mopassword.jsp">修改密码</a><i></i></li>
		</ul>    
	</dd>
	<dd>
		<div class="title">
		...
		<ul class="menuson">
			<li><cite></cite><a href="PfUserServlet">用户列表</a><i></i></li>
			<li><cite></cite><a href="Statisticsservlet">用户统计</a><i></i></li>
	...
	<dd>
		...
		<ul class="menuson">
			<li class="active"><cite></cite><a href="module_keyworkds/keyworkds.jsp" >关键词列表</a><i></i></li>
		</ul>
	</dd>
	<!-- 一个模块结束 -->
