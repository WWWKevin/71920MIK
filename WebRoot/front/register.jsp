...
<head>
    ...
    $.ajax({
    	...
    	success:function(data){
    	if(data=='ok'){
    	//var msg="<font color='red'>该用户已经被注册</font>"
    	$('#txt2').html("<font color='red'>该用户已经被注册</font>")
    		//alert("y")
    	}else{
    	//var msg="<font color='green'><a href="">发送验证码</a></font>"
    	$('#txt2').html("<a onclick='sendcode()'>发送验证码</a>")
    		//alert("n")
    	}
    	},
    	error:function(){
   	...
   	if(code1==code2){
   		window.location.href="front/register_2s.jsp";
   		}
    ...
    <div class="register">
        <form id="bdyz">
            <div class="tel clearfix">
                <span>手机号</span>
                <input name="phone" type="text" id="phone"  onblur="checkphone()">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>验证码</span>
