...
<body>
    ...
    <!-- 注册 -->
    <div class="register">
        <form  action="PersonalinformationSave" method="post">
        <div class="tel clearfix">
                <span>手机号</span>
                <input name="phonenum" value="${list.u_phonenum}" type="text">
                <i>不可修改</i>
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>用户名</span>
                <input name="u_nickname" value="${list.u_nickname}" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>生日</span>
                <input name="u_birthday" value="${list.u_birthday}" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>省</span>
                <input name="u_province" value="${list.u_province}" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>市</span>
                <input name="u_city" value="${list.u_city}" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>区</span>
                <input name="u_district" value="${list.u_district}" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span></span>
                <input type="submit" value="修改信息" class="sub">
            </div>
        </form>
        <script>
