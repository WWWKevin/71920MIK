    ...
    <div class="register">
        <form id="bdyz">
            <div class="tel clearfix">
                <span>现密码</span>
                <input id="oripwd" onblur="checkOripwd()" type="password" >
                <i>输入当前密码</i>
                <i id="m1"></i>
            </div>
            <div class="tel clearfix">
                <span>密码</span>
                <input id="pwd1" readonly="readonly" name="pwd1" type="text">
                <i id="txt2"></i>
            </div>
             <div class="tel clearfix">
                <span>确认密码</span>
                <input id="pwd2" onblur="checkSamePwd()"  readonly="readonly" name="pwd2" type="text">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span></span>
                <input disabled="disabled" id="sub" onclick='updatepwd()' type="submit" value="注册" class="sub">
            </div>
        </form>
        <script>
