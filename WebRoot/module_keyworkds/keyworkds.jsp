...
<div class="rightinfo">
	<div class="tools">
		<ul class="toolbar">
			...
			<li class="click" onclick="deletekeysWords()"><span><img src="images/t03.png"/></span>删除</li>
...
<script>
	...
	function ajax_return(str){
	var str1="";
			for(var i=0;i<str.length;i++){
			str1+=
			"<tr>"+
				"<td><input name='id'type='radio' value='"+str[i].id+"'/></td>"+
				"<td>"+str[i].id+"</td>"+
				"<td>"+str[i].keywords+"</td>"+
				"<td>"+str[i].createtime+"</td>"+
				"<td>操作</td>"
			"</tr>"
			}
			$('#tb').html(str1);
